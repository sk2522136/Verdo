  ...
  return (
    <div className='relative'>
      ...
      <div className='flex items-center mt-6 font-medium'>
         <Link to='/products'className='group flex itmes-center gap-2 px-7 md:px-9 py-3 
         bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointe'> 
          Shop now
          <img className='md:hidden transition group-hover:translate-x-1' src={assets.white_arrow_icon} alt="arrow" />        
           </Link>
           
           <Link to='/products'className='group hidden md:flex items-center gap-2  md:px-9 py-3 
            cursor-pointer'> 
           Explore deals
