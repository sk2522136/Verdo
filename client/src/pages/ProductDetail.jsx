        ...
        <div className= "mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                               ...
                               <img className="md:w-4 w-3.5" src={i<4 ? assets.star_icon :assets.star_dull_icon} alt="icon" /> 
                        ))}
           ...
           <div  className="flex flex-col items-center mt-20 ">
            <div className="flex flex-col items-center w-max">
                ...
                <div className="w-20 bg-primary h-0.5 rounded-full mt-2"></div>
            </div>
            ...
            <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className="max-auto cursor-pointer px-12 my-12 py-2.5 border rounded text-primary
